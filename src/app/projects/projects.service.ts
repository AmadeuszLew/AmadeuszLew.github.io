...
export class ProjectsService {
  ...
  private projectsDetail: ProjectDetail[] = [
    new ProjectDetail('TMS- team management system', "TMS", [
    ...
    new ProjectDetail('Sneakers shop', 'sneakers-shop', [
    ...
    new ProjectDetail('Stockx Fix Extension', 'stockx-fix-extension',[
    ...
    new ProjectDetail('Portfolio site', 'portfolio', [
    ...
    new ProjectDetail('Many more', 'github', [
