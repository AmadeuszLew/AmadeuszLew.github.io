...
export class ProjectsService {
    ...
    private projectsDetail:ProjectDetail[]=[
        new ProjectDetail('TMS- team management system',[
            ...
            new Feature('../assets/projects/TMS/players.png','Players list',"View with table listing all of the players. Search working with: name, last name, gender and email. Table is sortable with every given parameter. Fallowing F rule, button to edit and add button is available at the right top corner."),
            ...
            new Feature('../assets/projects/TMS/single_training.png','Single training view',"Here users can send notifications to players participating in selected training and view more details about the training."),
        ]),
        new ProjectDetail('Sneakers shop',[
            ...
            new Feature('../assets/projects/SneakerShop/product_page.png','Product page','Product page is made as simple as it is possible, for the best readability.'),
            ...
            new Feature('../assets/projects/more.jpg','More coming...','I am still working on this project. Items now are stored just in local storage, there is no user data. The goal is to store items on firebase, connect users to database, and add payment. UI is not finished also, it needs to be polished off.'),
        ]),
        new ProjectDetail('Stockx Fix Extension',[
            ...
            new Feature('../assets/projects/stockx/all_items.png','Check all items button','Function activated by clicking left button on top navbar. Highlights items where user price is not really the lowest'),
            ...
            new Feature('../assets/projects/stockx/item_with.png','Item view after using extension','Fields added by plugin calculate real price that user should have inserted to get the lowest ask, and displays it on the DOM. Another field is calculating user payout, so he can immediately know is it even worth it to place an ask.')
        ]),
        new ProjectDetail('Portfolio site',[
            ...
            new Feature('../assets/projects/more.jpg','More coming','I am still working on this website. I want to make it dual-language using pipe, add more animations to make it more user-friendly, work on mobile versions of images, make it more visible on Google, and more... ')
        ]),
        new ProjectDetail('GameHere',[
            new Feature('../assets/sorry.jpg','Sorry','This website does not exit for now :C'),
        ]),
